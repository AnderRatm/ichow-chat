...
package org.ichow.components
{
	...
	public class Panel extends Component
	{
		 ...
		 */
		public function Panel(parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number =  0, skin:String = "List_skin")
		{
		...
		override public function draw():void
		{
			...
			if (_bg != "") {
				_background.graphics.beginBitmapFill(Style.getSkin(_width, _height, _bg));
			}else {
				_background.graphics.beginBitmapFill(Style.getSkin(_width, _height, defSkin));
			}
		...
		/**
		 * Gets / sets the background skin of this panel
		 */
