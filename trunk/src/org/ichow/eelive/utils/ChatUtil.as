package org.ichow.eelive.utils 
{
	...
	public class ChatUtil 
	{
		...
		public static function escapeImg(html:String):String {
			...
			for each(var i:Object in srcList) {
		...
		public static function unescapeImg(str:String):String {
			if (!images) return "";
			var html:String = str;//"<html><body>" + str + "</body></html>";
			var faceList:Array = html.match(facesReg);
			for each(var i:Object in faceList) {
				if (images[i]) html = html.replace(faceReg, buildImgURL(images[i]));
			}
			return html;
		}
		
		public static function buildImgURL(imagePath:String):String {
